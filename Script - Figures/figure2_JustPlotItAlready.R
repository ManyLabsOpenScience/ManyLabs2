...
ggsave(plot = g2, filename = file.path(outdir,figname,".eps"),width=10, units = "in",dpi=600)
ggsave(plot = g2, filename = file.path(outdir,figname,".pdf"),width=10, units = "in",dpi=600)
ggsave(plot = g2, filename = file.path(outdir,figname,".png"),width=10, units = "in",dpi=600)
ggsave(plot = g2, filename = file.path(outdir,figname,".tiff"),width=10, units = "in",dpi=600)
